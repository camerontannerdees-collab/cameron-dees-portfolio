...
- Process-minded but adaptable
- Strong communicator
- Comfortable with ambiguity
- Quick learner
- Focused on practical solutions
- Values transparency and efficiency

## Professional Traits
Customer-focused, adaptable, analytical, operationally minded, product-oriented, organized, and solution-driven.

## Problem Solving Approach
Cameron approaches problems by understanding workflows, identifying friction points, gathering context, and finding practical solutions that improve both team operations and user experience.

## Values
Collaboration, efficiency, continuous improvement, clear communication, adaptability, and customer empathy.

## Projects

### DuckScout
- Live: https://duckscout.vercel.app/
- Type: Web App
...
- Camping
- Fly fishing
- Building web tools and apps with AI
